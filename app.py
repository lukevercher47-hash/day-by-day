# =====================================================
# Day By Day - Stable Version (Addresses your 3 issues)
# =====================================================
...
with st.sidebar:
    ...
    # Clean text inputs - fixes the zero problem
    income_str = st.text_input("Income ($)", value="", placeholder="0.00", key="income")
    spending_str = st.text_input("Spending ($)", value="", placeholder="0.00", key="spending")
    minutes_str = st.text_input("Active Minutes", value="", placeholder="0", key="minutes")
    miles_str = st.text_input("Miles Driven", value="", placeholder="0.0", key="miles")
